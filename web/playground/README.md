...
Production style is **Calm Ledger (Indigo)** only (`data-style="calm-ledger"`). On `/__design`, check pill buttons, card stat bar, airy issue rows, underline tabs, and dashed empty states.
