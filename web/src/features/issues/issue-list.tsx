...
import type { IssueSummary, ProjectRow } from "../../lib/api";
...
import {
  generateListTrendBuckets,
  inferIssueTrendStatus,
  issueLocationHint,
  parseIssueTitle,
  platformLabel,
  projectIssueCode,
        ...
        return (
          <div key={issue.id} data-issue-id={issue.id}>
            <IssueFeedRow
              ...
              trendBuckets={generateListTrendBuckets(issue)}
              trendStatus={inferIssueTrendStatus(issue)}
