        ...
        <section>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                They register with the invited email address.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <ul className="divide-y divide-border">
                {invitations.map((invitation) => (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3">
                      <div
                        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-border bg-bg-subtle text-ink-muted"
                        aria-hidden
                      >
                        <Mail size={14} />
                      </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {revealedInvite
                ? `Send this link to ${revealedInvite.email}. They must register using that email address.`
                : null}
            </DialogDescription>
          </DialogHeader>
          {revealedInvite ? (
