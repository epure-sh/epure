      ...
      <div className="flex-1 overflow-auto">
        ...
        <LabSection title="Theme guide (use bottom switcher)">
          <div className="grid gap-3 rounded-lg border border-border bg-surface p-4 text-sm text-ink-muted lg:grid-cols-3">
            <div>
              ...
              <p className="mt-1 text-xs">8px buttons · paper/indigo · unread = weight + edge · underline tabs · quiet empty</p>
            </div>
            <div>
        ...
        <LabSection title="Inputs · Card · Empty">
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-ink-muted">12px radius, hairline border, no shadow.</p>
              </CardContent>
            </Card>
            <Empty title="No unresolved exceptions" description="Quiet type and one next action — no dashed frame." />
          </div>
        </LabSection>
        ...
        <LabSection title="Issue row">
          <div className="overflow-hidden rounded-md border border-border bg-bg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[2.75rem_minmax(0,1fr)]">
              <div className="hidden items-stretch border-b border-border bg-accent-muted/70 lg:flex">
                <div className="flex w-full items-center justify-center border-r border-border px-2 py-3">
                  <span className="flex h-4 w-4 items-center justify-center rounded-sm border border-accent bg-accent-muted/60" />
                </div>
              </div>
        ...
        <LabSection title="List row">
          <ul className="epure-feed-table flex max-w-lg flex-col overflow-hidden rounded-lg border border-border bg-surface">
            <li>
              <ListRow variant="flat" className="flex-col gap-0.5 px-4 py-2.5">
                <span className="text-sm font-medium text-ink">Alert-style table row</span>
                <span className="text-xs text-ink-muted">Used on Alerts and Releases</span>
              </ListRow>
            </li>
            <li>
              <ListRow variant="flat" accent="danger" className="flex-col gap-0.5 px-4 py-2.5">
