...
export function CopyDsnBlock({
  ...
  if (compact) {
    return (
      <div className={cn("epure-copy-dsn flex min-w-0 items-center gap-2", className)}>
        <Input
          readOnly
          value={revealed ? dsn : "••••••••••••••••••••••••••••••••"}
        ...
        <button
          type="button"
          className="shrink-0 text-xs text-ink-muted underline-offset-2 hover:text-ink hover:underline focus-ring"
