...
export function SimpleFeedHeader({ title, actions, stats }: SimpleFeedHeaderProps) {
  return (
    <header className="epure-issues-feed-header shrink-0 border-b border-border bg-surface">
      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2 px-4 py-2.5 md:px-6">
        <h1 className="epure-page-title text-xl font-medium tracking-ui text-ink">{title}</h1>
