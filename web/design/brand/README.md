...
Calm Ledger identity: indigo instrument, lowercase wordmark, geometric restraint.

| Token | Light | Use |
|---|---|---|
| Accent | `#5a52e8` | Mark background |
| Accent contrast | `#ffffff` | Mark foreground |
| Ink | `#111827` | Wordmark |

Typography: **IBM Plex Sans Medium**, `tracking-ui` (−0.007em), always lowercase **epure**.

---

## Canonical mark — Pure Spike (#7)
...
| **7** | **Pure Spike** | Calm baseline + exception spike | **Canonical** |
...
- Lowercase **epure** only — never EPURE or Epure
