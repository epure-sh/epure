...
|---|---|---|
| Primary | `variant="primary"` | forest fill — **Resolve**, Mark resolved, form submit |
| Signal | `variant="signal"` | chartreuse CTA — setup/onboarding only (one per view) |
...
- Do not use `p-6` unless marketing layout
...
- Bulk: `bg-signal-muted/40` (distinct from read selection)
