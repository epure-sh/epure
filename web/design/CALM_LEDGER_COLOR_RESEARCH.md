...
**Indigo (`calm-ledger`)** is the only production style. Twelve color variants and two alternate geometry themes (Quiet Ledger, Calm Dense) were explored in the playground and removed after selection.
...
- **No style switcher** — single theme in app and playground
