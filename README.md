...
Expect protocol gaps, incomplete SDK coverage, and occasional breaking changes between minor releases. Prefer pinning an image tag in production (`EPURE_IMAGE=ghcr.io/epure-sh/epure:v0.1.1`), or track `:latest` if you accept rolling updates.
