...
Upgrade: `git pull && docker compose up -d --build` (prefer a release tag in production). Guide: [epure.sh/docs/self-hosting/upgrades](https://epure.sh/docs/self-hosting/upgrades).
